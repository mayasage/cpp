...
template <typename T>
void pe(T x, unsigned int colw = 0, unsigned int wsl = 0);

template <typename T>
void pen(T x, unsigned int colw = 0, unsigned int wsl = 0);

template <typename T>
void penn(T x, unsigned int colw = 0, unsigned int wsl = 0);

template <typename T>
void npe(T x, unsigned int colw = 0, unsigned int wsl = 0);

template <typename T>
void npen(T x, unsigned int colw = 0, unsigned int wsl = 0);

template <typename T>
void npenn(T x, unsigned int colw = 0, unsigned int wsl = 0);
...
template <typename T>
void pe(T x, unsigned int colw, unsigned int wsl)
{
  sw(colw);
  pb(wsl);
  std::cerr << x;
...
template <typename T>
void pen(T x, unsigned int colw, unsigned int wsl)
{
  pe(x, colw, wsl);
  pn();
}
...
template <typename T>
void penn(T x, unsigned int colw, unsigned int wsl)
{
  pe(x, colw, wsl);
  pn();
  pn();
...
template <typename T>
void npe(T x, unsigned int colw, unsigned int wsl)
{
  pn();
  pe(x, colw, wsl);
}
...
template <typename T>
void npen(T x, unsigned int colw, unsigned int wsl)
{
  pn();
  pe(x, colw, wsl);
  pn();
...
template <typename T>
void npenn(T x, unsigned int colw, unsigned int wsl)
{
  pn();
  pe(x, colw, wsl);
  pn();
